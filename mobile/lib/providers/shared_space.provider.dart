...
final currentSpaceMemberProvider =
    FutureProvider.family<SharedSpaceMemberResponseDto?, String>((
      ref,
      spaceId,
    ) async {
      final members = await ref.watch(
        sharedSpaceMembersProvider(spaceId).future,
      );
...
final spaceAssetsProvider = FutureProvider.family<List<RemoteAsset>, String>((
  ref,
  spaceId,
) async {
  final repository = ref.watch(sharedSpaceApiRepositoryProvider);
